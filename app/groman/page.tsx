  ...
  return (
    <main style={{ background: "#000", color: "#fff", minHeight: "100vh", padding: "24px" }}>
      <section style={{ maxWidth: 420, margin: "0 auto" }}>
        <h1 style={{ fontSize: 32, fontWeight: 700, marginBottom: 12 }}>A Memorial, Done For You</h1>

        <p style={{ color: "#aaa", marginBottom: 24 }}>Offered in partnership with Groman Mortuary</p>
        ...
        <div style={{ background: "#0a0a0a", borderRadius: 16, padding: 20, marginBottom: 24 }}>
          ...
          <p style={{ color: "#ccc", marginBottom: 8 }}>DIY: Canva, Staples, QR apps, pickups, stress.</p>
          <p style={{ color: "#7CFFB2" }}>DASH: Upload once. We handle everything.</p>
        </div>
